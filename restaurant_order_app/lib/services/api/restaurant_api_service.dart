      ...
      Restaurant(
        ...
        menu: [
          MenuItem(
            ...
            categories: ['Main Dishes', 'Rice', 'Beans'],
          ),
          MenuItem(
            id: '102',
            name: 'Jollof Rice',
      ...
      Restaurant(
        ...
        menu: [
          MenuItem(
            ...
            rating: 4.4,
            restaurantName: 'Katawodieso',
            restaurantId: '3',
            restaurantLocation: 'Accra',
            categories: ['Street Food', 'Plantain'],
          ),
          MenuItem(
            id: '302',
            name: 'Meat Pie',
          ...
          MenuItem(
            ...
            restaurantId: '3',
            restaurantLocation: 'Accra',
            categories: ['Main Dishes', 'Beans', 'Vegetarian'],
            isVegetarian: true,
          ),
        ],
      ),
      Restaurant(
        ...
        menu: [
          MenuItem(
            ...
            rating: 4.8,
            restaurantName: 'Kenkey Boutique',
            restaurantId: '4',
            restaurantLocation: 'Accra',
            categories: ['Main Dishes', 'Fish'],
            isSpicy: true,
      ...
      Restaurant(
        ...
        menu: [
          MenuItem(
            ...
            rating: 4.6,
            restaurantName: 'TubaaniHQ',
            restaurantId: '5',
            restaurantLocation: 'Accra',
            categories: ['Northern Specialties', 'Beans'],
            isVegetarian: true,
          ),
          MenuItem(
            id: '502',
            ...
            restaurantId: '5',
            restaurantLocation: 'Accra',
            categories: ['Northern Specialties', 'Soup'],
          ),
          MenuItem(
            id: '503',
            name: 'Kuli-Kuli',
